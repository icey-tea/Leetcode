...
##Use a two pointer system here, one fast and one slow
# if the pointers ever end up being the same at any point then retutn True
# else if the fast pointer reaches the end, then just return false