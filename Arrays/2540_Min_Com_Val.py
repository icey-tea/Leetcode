...
# Then we check if the num in nums1 is equals to the nums in num2
# If not then we check which number is smaller and just increment by one
# If none of them match then return -1