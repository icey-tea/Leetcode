...
# i with the radius k is the average of all elements in nums between the indices 
# i - k and i + k (inclusive). If there are less than k elements before or after the 
